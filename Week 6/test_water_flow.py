...
Code to test the equations on water_flow.py assignment
"""
...
convert_kilopascals_to_pounds_per_square_inch
import pytest

def test_water_column_height():
    """Verify that the water_column_height function works properly.
...
def test_pressure_loss_from_pipe():
    """Verify that the pressure_loss_from_pipe function 
    is working properly.
...
def test_pressure_loss_from_fittings():
    """Verify that the pressure_loss_from_fittings function 
    is working properly.
...
def test_reynolds_number():
    """Verify that the reynolds_number function 
    is working properly.
...
def test_pressure_loss_from_pipe_reduction():
    """Verify that the pressure_loss_from_pipe_reduction function 
    is working properly.
...
def test_convert_kilopascals_to_pounds_per_square_inch():
    """Verify that the convert_kilopascals_to_pounds_per_square_inch
    function works properly.
    
    Parameters: none
    Return: nothing
    """
    assert convert_kilopascals_to_pounds_per_square_inch(158.7) == approx(23.01, abs=0.01)
    assert convert_kilopascals_to_pounds_per_square_inch(100) == approx(14.50, abs=0.01)
    assert convert_kilopascals_to_pounds_per_square_inch(50) == approx(7.25, abs=0.01)
