...
def print_marriages(marriages_dict, people_dict):
    ...
    for marriage_key, marriage_list in marriages_dict.items():
        ...
        wife_age_marriage = wedding_date - wife_birth_year

        print(f'{husband_name}, {husband_age_marriage}, {wedding_date} || {wife_name}, {wife_age_marriage}')

def count_marriages(people_dict, marriages_dict):

    for _, person in people_dict.items():
        person.append(0)

    for mid, marriage in marriages_dict.items():
